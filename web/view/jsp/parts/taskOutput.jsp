...
<div class="table-container" id="tableContainer">
    ...
    <table class="text-center table-bordered table-hover" id="taskTable">
        ...
        <c:if test="${not empty tasks}">
            <c:import url="/view/jsp/parts/table/tableHeader.jsp"/>
        </c:if>
        ...
        <c:forEach var="task" items="${tasks}" varStatus="status">
            ...
            <c:import url="/view/jsp/parts/table/firstTableRow.jsp"/>

            <c:import url="/view/jsp/parts/table/descriptionSecondTableRow.jsp"/>

            <c:import url="/view/jsp/parts/table/changeDescriptionRow.jsp"/>

            <c:import url="/view/jsp/parts/table/changeDateRow.jsp"/>

            <c:import url="/view/jsp/parts/table/chooseFileAction.jsp"/>

            <c:import url="/view/jsp/parts/table/uploadFile.jsp"/>
    ...
    <c:import url="/view/jsp/parts/table/deleteTaskForm.jsp"/>
