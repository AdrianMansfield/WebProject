...
<tr class="modalDescription" id="${taskName}ChangeDate">
    <td colspan="5">
        <form action="ChangeTaskServlet" method="post">
            ...
            <input type="text" name="taskAttribute" value="${taskDate}" class="form-control" pattern="(0[1-9]|1[0-9]|2[0-9]|3[01]).(0[1-9]|1[012]).[0-9]{4}" data-valid-example="24.02.2018" placeholder="dd.mm.yyyy" required/>
