...
import by.gsu.epamlab.controllers.enums.ConferenceAddTypes;
...
public class AddConferenceServlet extends AbstractNonGetController {
    ...
    protected void performTask(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        try {
            ...
            ConferenceAddTypes.valueOf(taskType.toUpperCase()).addConference(userId, conference);
            jumpPage(Constants.PRINT_CONFERENCE_SERVLET_URL, request, response);
